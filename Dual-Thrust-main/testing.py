...
data_2018 = pd.read_csv('DataSet/hubo_btcusdt_2018.csv', index_col=1, header = None, names = ['ID', '开盘价', '收盘价', '最高价', '最低价','成交量', '成交额', '成交笔数'])
data_2019 = pd.read_csv('DataSet/huobi_btcusdt_2019.csv', index_col=1, header = None, names = ['ID', '开盘价', '收盘价', '最高价', '最低价','成交量', '成交额', '成交笔数'])
data_2020 = pd.read_csv('DataSet/huobi_btcusdt_2020.csv', index_col=1, header = None, names = ['ID', '开盘价', '收盘价', '最高价', '最低价','成交量', '成交额', '成交笔数'])
data_2021 = pd.read_csv('DataSet/huobi_btcusdt_2021.csv', index_col=1, header = None, names = ['ID', '开盘价', '收盘价', '最高价', '最低价','成交量', '成交额', '成交笔数'])
...
dual = Dual_Thrust(N=17, K1=0.7, K2=1, Freq='D')
dual.Input(Data = data_2020, Cap = 10000, Tran_fee = 0.003)
dual.trading()
dual.evaluate_stats()
dual.show_return()
